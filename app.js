...
app.use('/admin', adminRouter); //adds a default root to all requests handled by the admin router
app.use(shopRouter);
...
app.use( (req, res, next) => {
  res.status(404).render("error", {pageTitle: "404 Not Found!", path: "/error"});
});
